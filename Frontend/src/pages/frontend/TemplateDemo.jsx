...
import { ArrowLeft, Send, Sparkles, Smartphone, Monitor } from "lucide-react";
...
const TemplateDemo = () => {
  ...
  if (!template) {
    return (
      <div className="bg-slate-950 text-white min-h-screen flex flex-col items-center justify-center p-6 text-center">
        ...
        <p className="text-gray-400 mb-6">The template demo path you are looking for does not exist.</p>
        <Link to="/templates">
  ...
  return (
    <div className="bg-slate-950 text-white min-h-screen py-10 relative overflow-hidden">
      {/* Background blobs */}
      ...
      <div className="container mx-auto px-6 relative z-10 h-full flex flex-col">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
          <div className="flex items-center gap-3">
            <Link to="/templates" className="p-2.5 bg-white/5 border border-white/10 hover:bg-white/10 text-white rounded-xl transition-all cursor-pointer">
              <ArrowLeft size={16} />
            </Link>
            <div>
